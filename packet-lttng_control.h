 ...
 */
#ifndef WS_LTTNG_PACKET_LTTNG_CONTROL_H
#define WS_LTTNG_PACKET_LTTNG_CONTROL_H

#include <gmodule.h>       /* Glib */
#include <config.h>        /* Wireshark's config header */
#include <epan/packet.h>   /* Should be first Wireshark include (other than config.h) */

extern void lttng_control_proto_reg_handoff(void);
extern void lttng_control_proto_register(void);
extern int lttng_control_dissect(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data);

#endif /* WS_LTTNG_PACKET_LTTNG_CONTROL_H */
